...
class QuickListTest {
    ...
    @Test
    void whenReverseOrderUsersInLinkedList() {
        User user1 = new User(1, "11");
        User user2 = new User(1, "22");
        User user3 = new User(3, "33");
        User user4 = new User(-4, "44");
        User user5 = new User(4, "55");
        User user6 = new User(6, "66");
        Comparator<User> comparator = new CompareUsersByName().reversed();
    ...
    private static class CompareUsersByName implements Comparator<User> {
